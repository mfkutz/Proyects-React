...
export default function Header() {
    ...
    const searchRecipies = useAppStore((store) => store.searchRecipies)
            ...
            <div className="mx-auto container px-5 py-16">
                ...
                {isHome && (
                    ...
                    >
                        ...
                        {/* <input
                            type="text"
                            className="cursor-pointer bg-orange-800 hover:bg-orange-900 text-white font-extrabold w-full p-2 rounded-lg uppercase text-center"
                        >
                            Buscar Receta
                        </input> */}
                        <button
